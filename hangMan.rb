class Hangman
    ...
    def words
        [
            ...
            ["jogging", "Do this every morning to stay healthy."],
            ["python", "A programming language which is also associated with the name of an animal."],
            ["birthday", "This day comes only once a year for every person."],
            ["metaverse", "A VR technology associated with cryptocurrency."],
            ["ruby", "A programming language, also associated with the name of a gem."],
        ]
    end
